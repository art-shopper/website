...
describe('User', () => {
  ...
  describe('class methods', () => {
    ...
    beforeEach('Create a user', () => {
      ...
      .then(() => user2.createOrder())
      .then(() => user2.createOrder())
      .then(() => user1.createReview({title: "The Moss", text: "This guy's afro is crazy wowww!!!", rating: 5, productId: 1}))
      .then(() => user2.createReview({title: "The Boss", text: "This guy's afro is crazy wowww!!!", rating: 5, productId: 1}))
      .then(() => user2.createReview({title: "The Ross", text: "This guy's afro is crazy wowww!!!", rating: 5, productId: 1}))
    })
